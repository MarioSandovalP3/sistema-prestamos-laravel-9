    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <label>Role <i class="text-danger">*</i> @error('roleName') <span class="text-danger er">{{$message}}</span> @enderror</label>
            ...
            <div class="modal-footer">
                @if($selected_id < 1)
                <button type="button" wire:click.prevent="CreateRole()" class="btn btn-border border btn-outline-info btn-responsive close-modal" >
                GUARDAR
                </button>
                @else
                <button type="button" wire:click.prevent="UpdateRole()" class="btn btn-border border btn-outline-info btn-responsive close-modal" >
                ACTUALIZAR
                </button>
                @endif
